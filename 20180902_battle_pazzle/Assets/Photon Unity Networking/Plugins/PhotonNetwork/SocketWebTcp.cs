...
namespace ExitGames.Client.Photon
{
    ...
    public class SocketWebTcp : IPhotonSocket, IDisposable
    {
        ...
        public override bool Connect()
        {
            ...
            // webgl
                this.sock = new WebSocket(new Uri(this.ServerAddress));          // TODO: The protocol should be set based on current PeerBase value (but that's currently not accessible)
            #endif
